...
import DetailsZoneRevenueDisbursement from "@Modules/accounting/zoneRevenueDisbursement/DetailsZoneRevenueDisbursement";
  ...
  return (
    <>
      ...
      {ability.can("zoneRevenueDisbursement.view", "") ? (
        <DetailsZoneRevenueDisbursement id={id} />
      ) : (
        <Forbidden />
      )}
    </>
