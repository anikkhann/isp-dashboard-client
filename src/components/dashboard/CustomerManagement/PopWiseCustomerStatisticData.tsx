...
const PopWiseCustomerStatisticData = () => {
  ...
  const fetchData = async () => {
    ...
    const { data } = await axios.get(
      `/api/dashboard/get-total-customer-pop-wise`,
      {
        headers: {
  ...
  const { isLoading, isError, error, isFetching } = useQuery<boolean, any>({
    queryKey: ["dashboard-get-total-customer-pop-wise-cm"],
    queryFn: async () => {
...
export default PopWiseCustomerStatisticData;
