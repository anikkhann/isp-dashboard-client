        ...
        >
          <div>
            ...
            >
              ...
              <Col>
                <span className="mx-1 text-base">{item.connectionAddress}</span>
              </Col>
            </Row>
            <Row
              style={{
        ...
        >
          <div>
            ...
            >
              ...
              >
                <span className="font-bold text-base">Client Status :</span>
              </Col>
              <Col>
                <span className="mx-1 text-base">{item.clientStatus}</span>
              </Col>
            </Row>
            <Row
              style={{
            ...
            >
              ...
              >
                <span className="font-bold text-base">Zone Note :</span>
              </Col>
              <Col>
            ...
            >
              ...
              >
                <span className="font-bold text-base">Zone Status :</span>
              </Col>
              <Col>
                <span className="mx-1 text-base">{item.zoneStatus}</span>
              </Col>
            </Row>
          </div>
        </Card>
