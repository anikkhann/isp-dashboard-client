...
const HotspotMacBindingHistory = ({ item }: PropData) => {
  ...
  const fetchData = async (
    ...
    const { data } = await axios.post(
      "/api-hotspot/customer-mac/get-list",
      body,
      {
        headers: {
  ...
  const { isLoading, isError, error, isFetching } = useQuery<boolean, any>({
    queryKey: ["customer-mac-list", page, limit, order, sort],
    queryFn: async () => {
...
export default HotspotMacBindingHistory;
