...
const DetailsOtherProductData = ({ item }: PropData) => {
        ...
        >
          <div>
            ...
            >
              ...
              <Col>
                <span className="mx-1 text-base">{item.unit}</span>
              </Col>
            </Row>
            ...
            >
              ...
              <Col>
                <span className="mx-1 text-base">{item.description}</span>
              </Col>
            </Row>
            {/*
            <Row
        ...
        >
          <div>
            ...
            >
              ...
              <Col>
                <span className="mx-1 text-base">{item.updatedBy}</span>
              </Col>
            </Row>
            <Row
              style={{
...
export default DetailsOtherProductData;
