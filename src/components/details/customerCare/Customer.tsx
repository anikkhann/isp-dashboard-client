        ...
        >
          <div style={{ textAlign: "start" }}>
            <p className="flex flex-row   overflow-hidden">
              <span className="font-bold flex">Distribution Zone</span>
              <span className="mx-1">:</span>
              <span className="mx-1">{item?.distributionZone?.name}</span>
            </p>
            <p className="flex flex-row   overflow-hidden">
              <span className="font-bold flex">Distribution Pop</span>
              <span className="mx-1">:</span>
              <span className="mx-1">{item?.distributionPop?.name}</span>
            </p>
            <p className="flex flex-row   overflow-hidden">
