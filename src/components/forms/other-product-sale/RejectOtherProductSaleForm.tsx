...
const RejectOtherProductSaleForm = ({ item }: PropData) => {
  ...
  const onSubmit = (data: FormData) => {
    ...
    const formData = {
      id: item.id,
      rejectComment: remarks
    };

    try {
      axios
        .put("/api-hotspot/other-product-sales/reject", formData)
        .then(res => {
          const { data } = res;
...
export default RejectOtherProductSaleForm;
