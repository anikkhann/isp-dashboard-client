...
const CreateRetailerUpdateForm = () => {
  ...
  const onSubmit = (data: FormData) => {
    ...
    try {
      axios
        .post("/api/customer/retailer-assign", formData)
        .then(res => {
          const { data } = res;
          ...
          if (data.status == 200) {
            MySwal.fire({
              ...
              router.replace(`/admin/retailer-tag-or-remove`);
            });
          }
        })
        .catch(err => {
...
export default CreateRetailerUpdateForm;
