...
//   console.log("previous", previous.dateOfBirth);
//   // ** States
...
//   console.log("birth", selectedDateOfBirth);
//   // const formattedDateOfBirth = selectedDateOfBirth ? dayjs(selectedDateOfBirth).format('YYYY-MM-DD') : null;
...
//   useEffect(() => {
//     if (previous) {
//       setTypeOfCustomer(previous.typeOfCustomer);
//       setSelectedDateOfBirth(dayjs(previous.dateOfBirth).format("YYYY-MM-DD"));
...
//                           }}
//                         >
//                           <Radio value="individual">ব্যক্তি / Individual</Radio>
...
//                                 // defaultValue={
//                                 //   selectedDateOfBirth
//                                 //     ? dayjs(selectedDateOfBirth).format(
//                                 //         "YYYY-MM-DD"
//                                 //       )
//                                 //     : null
//                                 // }
//                                 defaultValue={selectedDateOfBirth}
//                               />
//                             </Form.Item>
//                           </Col>
//                           <Col span={12}>
...
const CreateSafVerificationForm = ({ item }: PropData) => {
  ...
  // dateOfBirth
  const [selectedDateOfBirth, setSelectedDateOfBirth] = useState<any>(null);
  console.log("date", selectedDateOfBirth);
  const { useBreakpoint } = Grid;
  ...
  const next = async () => {
    ...
    try {
      if (current === 0) {
        ...
        // console.log("mobile", form.getFieldValue("mobileNumber"));
        // console.log("phone", form.getFieldValue("phoneNumber"));
        ...
        setFormValues({
          ...
          alternateMobileNo: form.getFieldValue("alternateMobileNo"),
          email: form.getFieldValue("email")
          // occupation: form.getFieldValue("occupation")
        });
        console.log("mobile", form.getFieldValue("mobileNumber"));
  ...
  useEffect(() => {
    if (previous) {
      ...
      form.setFieldsValue({
        ...
        alternateMobileNo: previous.alternateMobileNo,
        email: previous.email,
        connectionAddress: previous.connectionAddress,
        connectionAddressDivisionId: previous.connectionAddressDivisionId,
        connectionAddressDistrictId: previous.connectionAddressDistrictId,
