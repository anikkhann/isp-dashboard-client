...
const EditRetailerOnboardForm = ({ item }: PropData) => {
  ...
  const onSubmit = (data: FromData) => {
    ...
    try {
      axios
        .put("/api-hotspot/retailer-on-board/update", formData)
        .then(res => {
          const { data } = res;
                ...
                >
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please input Alt Contact No!"
                      }
                    ]}
                  >
                    <Input placeholder="Alt Contact No" />
                  </Form.Item>
                </Col>
                <Col
                  xs={24}
...
export default EditRetailerOnboardForm;
