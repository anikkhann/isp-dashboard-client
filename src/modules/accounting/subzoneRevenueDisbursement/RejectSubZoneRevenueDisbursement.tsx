...
const RejectSubZoneRevenueDisbursement = ({ id }: any) => {
      ...
      <AppRowContainer>
        <Breadcrumb
          ...
          items={[
            ...
            {
              title: "Reject subZone Revenue Disbursement"
            }
          ]}
        />
        <div
        ...
        >
          ...
          >
            Reject subZone Revenue Disbursement
          </h1>
        </div>
        <Card
...
export default RejectSubZoneRevenueDisbursement;
