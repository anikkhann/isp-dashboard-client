...
const SearchStaticIpAssignList = () => {
  ...
  const handleSubmit = async (
    ...
    const body = {
      ...
      body: {
        ...
        subject: "Customer IP Assign Update",
        dateRangeFilter: {
          field: "createdOn",
      ...
      <AppRowContainer>
        <Breadcrumb
          ...
          items={[
            ...
            {
              title: "Static IP Assign Or Remove"
            }
          ]}
        />
        <div
          ...
          extra={
            <>
              <Can I="customerCare.list">
                <Link href="/admin/static-ip-assign/create">
                  <Button
                    type="primary"
...
export default SearchStaticIpAssignList;
