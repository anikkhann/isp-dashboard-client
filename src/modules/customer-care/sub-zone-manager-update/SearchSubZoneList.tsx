  ...
  const handleSubmit = async (
    ...
    const body = {
      ...
      body: {
        ...
        subject: "Sub Zone Manager Update",
        dateRangeFilter: {
          field: "createdOn",
          ...
          extra={
            <>
              <Can I="customerCare.list">
                <Link href="/admin/sub-zone-manager-tag-or-remove/create">
                  <Button
                    type="primary"
          ...
          <>
            <Space style={{ marginBottom: 16 }}>
              <div style={{ padding: "20px", backgroundColor: "white" }}>
                ...
                >
                  <Panel header="SZM Update Filters" key="1">
                    <Row
...
export default SearchSubZoneList;
