...
import DetailsIpData from "@/components/details/ip/DetailsIpData";
...
const DetailsIpManagement = ({ id }: any) => {
    ...
    <>
      <AppRowContainer>
        ...
        >
          ...
          {!isLoading && item && <DetailsIpData item={item} />}
        </Card>
      </AppRowContainer>
    </>
  );
...
export default DetailsIpManagement;
