...
const HotspotMyRevenueList: React.FC = () => {
  ...
  const fetchData = async (
    ...
    const packageId = selectedPackageParam ? selectedPackageParam : "";

    const startDate = startDateParam ? startDateParam : "";
    const endDate = endDateParam ? endDateParam : "";

    const { data } = await axios.get(
      `/api-hotspot/revenue-report/my-revenue?clientId=${clientID}&zoneManagerId=${zoneManagerId}&subZoneManagerId=${subZoneManagerId}&retailerId=${retailerId}&packageId=${packageId}&startDate=${startDate}&endDate=${endDate}`,
      {
        params: {
          page,
          limit,
        ...
        <Col span={24} key="data-f">
          ...
          >
            <Space direction="vertical" style={{ width: "100%" }}>
              ...
              {ability.can("myRevenue.download", "") && (
                <Row justify={"end"}>
                  <Col span={3}>
                    <CSVLink
                      data={data}
...
export default HotspotMyRevenueList;
