...
import EditRetailerOnboardForm from "@/components/forms/retailer-onboard/EditRetailerOnboardForm";

const EditRetailerOnboard = ({ id }: any) => {
    ...
    <>
      <AppRowContainer>
        ...
        >
          ...
          {!isLoading && item && <EditRetailerOnboardForm item={item} />}
        </Card>
      </AppRowContainer>
    </>
  );
...
export default EditRetailerOnboard;
