...
const HotspotPackageList: React.FC = () => {
  ...
  const fetchData = async (
    ...
    const { data } = await axios.post(
      `/api-hotspot/pricing-plan/get-list`,
      body,
      {
        headers: {
        ...
        return (
          <div className="flex flex-row">
            <Space size="middle" align="center">
              {ability.can("hotspotPackage.update", "") ? (
                <Tooltip title="Edit" placement="bottomRight" color="magenta">
                  <Space size="middle" align="center" wrap>
                    <Link href={`/admin/hotspot/package/${record.id}/edit`}>
            ...
            <Space size="middle" align="center" className="mx-1">
              {ability.can("hotspotPackage.view", "") ? (
                <Tooltip title="View" placement="bottomRight" color="green">
                  <Space size="middle" align="center" wrap>
                    <Link href={`/admin/hotspot/package/${record.id}`}>
      ...
      <AppRowContainer>
        <Col span={24} key="data-f">
          ...
          <TableCard
            title="Package List"
            hasLink={true}
            addLink="/admin/hotspot/package/create"
            permission="hotspotPackage.create"
            style={{
              borderRadius: "10px",
              padding: "10px",
              width: "100%",
...
export default HotspotPackageList;
