...
const HotspotRetailerRevenueList: React.FC = () => {
  ...
  const fetchData = async (
    ...
    const { data } = await axios.get(
      `/api-hotspot/revenue-report/retailer-wise-revenue?clientId=${clientID}&zoneManagerId=${zoneManagerId}&subZoneManagerId=${subZoneManagerId}&retailerId=${retailerId}&startDate=${startDate}&endDate=${endDate}`,
      {
        params: {
          page,
          limit,
  ...
  const handleDownload = async () => {
    ...
    try {
      const res = await axios.get(
        `/api-hotspot/revenue-report/retailer-wise-revenue`,
        {
          headers: {
        ...
        <Col span={24} key="data-f">
          ...
          >
            <Space direction="vertical" style={{ width: "100%" }}>
              ...
              {ability.can("retailerRevenue.download", "") && (
                // <Row justify={"end"}>
                //   <Col span={3}>
                //     <CSVLink
                //       data={data}
...
export default HotspotRetailerRevenueList;
