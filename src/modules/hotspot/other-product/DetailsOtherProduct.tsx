...
import DetailsOtherProductData from "@/components/details/other-product/DetailsOtherProductSaleData";

const DetailsOtherProduct = ({ id }: any) => {
    ...
    <>
      <AppRowContainer>
        ...
        >
          ...
          {!isLoading && item && <DetailsOtherProductData item={item} />}
        </Card>
      </AppRowContainer>
    </>
  );
...
export default DetailsOtherProduct;
