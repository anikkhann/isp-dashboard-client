...
import EditRetailerTaggingForm from "@/components/forms/retailer-tagging/EditRetailerTaggingForm";

const EditRetailerTagging = ({ id }: any) => {
    ...
    <>
      <AppRowContainer>
        ...
        >
          ...
          {!isLoading && item && <EditRetailerTaggingForm item={item} />}
        </Card>
      </AppRowContainer>
    </>
  );
...
export default EditRetailerTagging;
