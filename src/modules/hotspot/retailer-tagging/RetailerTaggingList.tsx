...
const RetailerTaggingList: React.FC = () => {
  ...
  const [tsoManagers, setTsoManagers] = useState<any[]>([]);
  const [selectedTsoManager, setSelectedTsoManager] = useState<any>(null);
  ...
  const fetchData = async (
    ...
    const { data } = await axios.post(`/api/tso-retailer-tag/get-list`, body, {
      headers: {
...
export default RetailerTaggingList;
