...
import ApproveCustomerReqForm from "@/components/forms/customer-req/ApproveCustomerReqForm";
...
const ApproveCustomerOnboardingReq = ({ id }: any) => {
      ...
      <AppRowContainer>
        <Breadcrumb
          ...
          items={[
            ...
            {
              title: "Approve Customer Request"
            }
          ]}
        />
        <div
        ...
        >
          ...
          {!isLoading && item && <ApproveCustomerReqForm item={item} />}
        </Card>
      </AppRowContainer>
    </>
  );
...
export default ApproveCustomerOnboardingReq;
