...
import RejectCustomerReqForm from "@/components/forms/customer-req/RejectCustomerReqForm";
...
const RejectCustomerOnboardingReq = ({ id }: any) => {
    ...
    <>
      <AppRowContainer>
        ...
        >
          ...
          {!isLoading && item && <RejectCustomerReqForm item={item} />}
        </Card>
      </AppRowContainer>
    </>
  );
...
export default RejectCustomerOnboardingReq;
