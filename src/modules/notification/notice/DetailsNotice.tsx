...
import DetailsNoticeBoardData from "@/components/details/notice/DetailsNoticeBoardData";
    ...
    <>
      <AppRowContainer>
        ...
        >
          ...
          {!isLoading && item && <DetailsNoticeBoardData item={item} />}
        </Card>
      </AppRowContainer>
    </>
  );
